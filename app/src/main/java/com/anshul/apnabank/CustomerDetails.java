...
public class CustomerDetails extends AppCompatActivity {
    List<com.anshul.apnabank.Model.CustomerDetails> customerDetailsList;
    com.anshul.apnabank.Model.CustomerDetails senderCustomer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customerDetailsList = (List<com.anshul.apnabank.Model.CustomerDetails>) getIntent.getSerializableExtra("list");
        senderCustomer = (com.anshul.apnabank.Model.CustomerDetails) getIntent.getSerializableExtra("selectedCustomer");
            ...
            public void onClick(View view) {
                if(TextUtils.isEmpty(transferAmount)){
                    ...
                    if(transferAmountINT > userAmountINT.get()){
                        ...
                        com.anshul.apnabank.Model.CustomerDetails receiverCustomer = new com.anshul.apnabank.Model.CustomerDetails();
                        for(com.anshul.apnabank.Model.CustomerDetails customerDetails : customerDetailsList){
